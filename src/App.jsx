...
function App() {
  return (
    <div className={styles.App}>
      ...
      <main>
        <p>
          This is the website's example from the  Web Design Accessibility Udemy course that had some accessibility issues. I used
          the tools we learnt about in the course to debug the issues:
          <ul>
            <li>Unclear link and button text</li>
            <li>Headings not in order</li>
            <li>Insufficient color contrast between the caption text/button text and their backgrounds</li>
            <li>Alt attribute text: <ol>
              <li>Reduntand on first image</li>
              <li>Missing on second image</li></ol></li>
              <li>Links too close together</li>
              <li>Unlabelled form input</li>
          </ul>
        </p>
        <section className={styles.fontInfo}>
    <p>This font is also accessible.  </p>
   
    <p> Looking at the counter, the negative space inside the letters, we can clearly dinstict the<em> 'c'</em> from the <em>'e'</em> and from the <em>'o'</em>.   </p>
    <p> The same is for <em>'0'</em> <em> 'O'</em> and <em>'C'</em>.   </p>
    <p>It's also easy to distinguish <em>'6'</em> from <em>'9'</em>,<em>'i'</em>  from <em>'!'</em> and <em>'g'</em> from <em>'9'</em>.   </p>
    <p>The differences among <em>'1'</em>, <em>'l'</em> and <em>'I'</em> are relevant too.  </p>
    <p> And finally the <em>'rn'</em> is shaped so that it can not be mistaken by <em>'m'</em>.
    </p>
    </section>
        <p>
